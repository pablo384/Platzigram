...
//paso 1                                paso 5
public class PictureAdapterRecyclerView extends RecyclerView.Adapter<PictureAdapterRecyclerView.PictureiewHolder>{

    //paso 10
    private ArrayList<Picture> pictures; //lista de objetos que recibiremos y estaremos manejando
    ...
    public void onBindViewHolder(PictureiewHolder holder, int position) {
        ...
        holder.likenumbercard.setText(picture.getLikenumbre());
        //holder.picturecard.setImageURI(picture.getPicture());
        Picasso.with(activity).load(picture.getPicture()).fit().into(holder.picturecard);

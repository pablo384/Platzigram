            ...
            public void onTabSelected(@IdRes int tabId) {
                switch (tabId){
                    ...
                    case R.id.search_tab:
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.container,searchF)
                    ...
                    case R.id.home_tab:
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.container,homeF)
                                .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                                .addToBackStack(null).commit();
                        break;
                    ...
                    case R.id.profile_tab:
                        ...
                        getSupportFragmentManager().beginTransaction().replace(R.id.container,profileF)
                                .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE)
                                .addToBackStack(null).commit();
                        break;
